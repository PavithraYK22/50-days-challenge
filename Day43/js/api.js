...
// ------------------------------------------
// Day 40: Import IndexedDB Function
// ------------------------------------------
...
// ==========================================
// POST REQUEST
// Day 40: Offline IndexedDB Support
// ==========================================
...
export async function postData(url, data) {
    ...
    try {
        ...
        // --------------------------------------
        // DAY 40: Check Network Status
        // --------------------------------------

        if (!navigator.onLine) {

            console.log(
                "User is offline. Saving POST data to IndexedDB..."
            );
            ...
            // Tell the user
            alert(
                "You are offline. Your data has been saved locally and will be synchronized when you are online."
            );
...
export async function secureDeleteResource(targetId) {
    ...
    try {
        ...
        console.log(
            "Secure DELETE request successful."
        );
