...
const increaseCartBtn = document.getElementById("increase-cart-btn");
const decreaseCartBtn = document.getElementById("decrease-cart-btn");
...
const unsubscribe = globalStore.subscribe((state) => {
    ...
    // Update cart count
    if (globalCartCount) {
        globalCartCount.textContent = state.cartCount;
    }

    // Update theme text
    if (globalTheme) {
        globalTheme.textContent = state.userTheme;
    }
...
if (increaseCartBtn) {
    ...
    increaseCartBtn.addEventListener("click", () => {
...
if (decreaseCartBtn) {
    ...
    decreaseCartBtn.addEventListener("click", () => {

        const currentCount = globalStore.state.cartCount;
...
if (toggleThemeBtn) {
    ...
    toggleThemeBtn.addEventListener("click", () => {
        ...
        const currentTheme = globalStore.state.userTheme;
